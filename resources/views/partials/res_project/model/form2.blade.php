...
<div class="col-md-6 col-sm-12">
  <form class="toratto-section-model-form" id="toratto-modal-form" type="post" action="">
    ...
    <div class="form-row">
      <div class="form-group col-md-6">
        <label for="toratto-contact-form-fullname">Email <span class="toratto-form-required">*<span></label>
        <input type="email" class="form-control" id="toratto-contact-form-fullname" name="toratto-contact-form-fullname" required>
      </div>
      <div class="form-group col-md-6">
        <label for="toratto-contact-form-phone">Descripción: <span class="toratto-form-required">*<span></label>
        <input type="text" class="form-control" id="toratto-contact-form-phone" name="toratto-contact-form-phone" required>
      </div>
    </div>
    ...
    <div class="form-group">
      ...
      <button
        ...
        type="submit"
        class="btn btn-toratto-green animate__animated animate__fadeInLeft"
